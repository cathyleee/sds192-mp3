...
**Problem Statement:** Besides assigning difficulty levels to the MacLeish trails based on length and elevation, we decided to classify the trails based on biodiversity and proximity to Arts Afield Sites after talking to Professor Bertone Johnson about other possible classifications.
...
```
The map shows an anomaly: two segments in the Easy Out trail are not continuous; after consulting Professor Bertone-Johnson, we found out that they are connectors allowing access to the Eastern Loop trail.
